...
moduleForModel('i-i-s-hardware-and-software-accounting-user', 'Unit | Serializer | i-i-s-hardware-and-software-accounting-user', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-hardware-and-software-accounting-user',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
