...
moduleForModel('i-i-s-hardware-and-software-accounting-branch-office', 'Unit | Serializer | i-i-s-hardware-and-software-accounting-branch-office', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-hardware-and-software-accounting-branch-office',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
