...
moduleForModel('i-i-s-hardware-and-software-accounting-workplace', 'Unit | Serializer | i-i-s-hardware-and-software-accounting-workplace', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-hardware-and-software-accounting-workplace',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
