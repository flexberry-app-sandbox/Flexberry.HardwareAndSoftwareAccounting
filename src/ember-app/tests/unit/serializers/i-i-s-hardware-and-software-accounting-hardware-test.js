...
moduleForModel('i-i-s-hardware-and-software-accounting-hardware', 'Unit | Serializer | i-i-s-hardware-and-software-accounting-hardware', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-hardware-and-software-accounting-hardware',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
