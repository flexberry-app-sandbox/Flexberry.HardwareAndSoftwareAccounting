...
moduleForModel('i-i-s-hardware-and-software-accounting-vendor', 'Unit | Serializer | i-i-s-hardware-and-software-accounting-vendor', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-hardware-and-software-accounting-vendor',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
