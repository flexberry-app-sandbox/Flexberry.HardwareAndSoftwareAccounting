...
moduleForModel('i-i-s-hardware-and-software-accounting-software', 'Unit | Serializer | i-i-s-hardware-and-software-accounting-software', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-hardware-and-software-accounting-software',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
