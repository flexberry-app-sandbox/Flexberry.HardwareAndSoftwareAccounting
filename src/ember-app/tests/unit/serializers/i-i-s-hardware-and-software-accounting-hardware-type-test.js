...
moduleForModel('i-i-s-hardware-and-software-accounting-hardware-type', 'Unit | Serializer | i-i-s-hardware-and-software-accounting-hardware-type', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-hardware-and-software-accounting-hardware-type',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
