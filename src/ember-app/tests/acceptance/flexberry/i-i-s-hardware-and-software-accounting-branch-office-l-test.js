...
moduleForAcceptance('[AGAT] Acceptance | i i s hardware and software accounting branch office l');

test('testing i-i-s-hardware-and-software-accounting-branch-office-l', function(assert) {
