...
moduleForAcceptance('[AGAT] Acceptance | i i s hardware and software accounting hardware l');

test('testing i-i-s-hardware-and-software-accounting-hardware-l', function(assert) {
