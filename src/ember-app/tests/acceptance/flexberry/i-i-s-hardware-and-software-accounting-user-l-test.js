...
moduleForAcceptance('[AGAT] Acceptance | i i s hardware and software accounting user l');

test('testing i-i-s-hardware-and-software-accounting-user-l', function(assert) {
