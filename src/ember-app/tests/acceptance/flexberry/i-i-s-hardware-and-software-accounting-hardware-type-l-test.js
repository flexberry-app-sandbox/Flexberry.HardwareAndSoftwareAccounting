...
moduleForAcceptance('[AGAT] Acceptance | i i s hardware and software accounting hardware type l');

test('testing i-i-s-hardware-and-software-accounting-hardware-type-l', function(assert) {
