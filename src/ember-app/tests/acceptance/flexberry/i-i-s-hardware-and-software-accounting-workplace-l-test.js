...
moduleForAcceptance('[AGAT] Acceptance | i i s hardware and software accounting workplace l');

test('testing i-i-s-hardware-and-software-accounting-workplace-l', function(assert) {
