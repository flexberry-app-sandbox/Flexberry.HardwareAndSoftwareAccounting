...
moduleForAcceptance('[AGAT] Acceptance | i i s hardware and software accounting vendor l');

test('testing i-i-s-hardware-and-software-accounting-vendor-l', function(assert) {
