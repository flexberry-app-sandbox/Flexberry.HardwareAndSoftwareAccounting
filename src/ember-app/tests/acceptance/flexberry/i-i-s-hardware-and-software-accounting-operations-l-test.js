...
moduleForAcceptance('[AGAT] Acceptance | i i s hardware and software accounting operations l');

test('testing i-i-s-hardware-and-software-accounting-operations-l', function(assert) {
