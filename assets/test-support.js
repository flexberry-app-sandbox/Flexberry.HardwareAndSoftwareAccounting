...
define('ember-flexberry/test-support/check-close-edit-form', [], function () {
  'use strict';

  Ember.Test.registerAsyncHelper('checkCloseEditForm', function (app, olvSelector, context, assert, path) {
    ...
    const waiterFunction = () => {
      return helpers.currentPath() === editFormRoute;
    };
...
define('ember-flexberry/test-support/check-delete-record-from-e-form', ['moment', 'ember-flexberry-data/utils/generate-unique-id', 'ember-flexberry/test-support/utils/create-recort-for-test'], function (_moment, _generateUniqueId, _createRecortForTest) {
  'use strict';

  Ember.Test.registerAsyncHelper('checkDeleteRecordFromEditForm', function (app, olvSelector, context, assert, store, model, prop) {
    const helpers = app.testHelpers;
    const olv = helpers.findWithAssert(olvSelector, context);

    const currentData = (0, _moment.default)().format('DD.MM.YYYY HH:mm');
    const deleteRecordId = (0, _generateUniqueId.default)();

    (0, _createRecortForTest.createRecord)(store, model, prop, deleteRecordId, currentData).then(() => {
...
define('ember-flexberry/test-support/check-delete-record-from-olv', ['moment', 'ember-flexberry-data/utils/generate-unique-id'], function (_moment, _generateUniqueId) {
  'use strict';

  Ember.Test.registerAsyncHelper('checkDeleteRecordFromOlv', function (app, olvSelector, context, assert, store, model, prop) {
    const helpers = app.testHelpers;
    const olv = helpers.findWithAssert(olvSelector, context);

    const currentData = (0, _moment.default)().format('DD.MM.YYYY HH:mm');
    const deleteUseRowButton = (0, _generateUniqueId.default)();
    const deleteUseRowMeny = (0, _generateUniqueId.default)();
    const deleteUseToolbar1 = (0, _generateUniqueId.default)();
    const deleteUseToolbar2 = (0, _generateUniqueId.default)();

    Ember.RSVP.all([createRecord(store, model, prop, deleteUseRowButton, currentData), createRecord(store, model, prop, deleteUseRowMeny, currentData), createRecord(store, model, prop, deleteUseToolbar1, currentData), createRecord(store, model, prop, deleteUseToolbar2, currentData)]).then(() => {
          ...
          helpers.andThen(() => {
            ...
            helpers.andThen(() => {
              ...
              helpers.andThen(() => {
                ...
                checkboxRowButton.forEach(checkbox => {
                  helpers.click(checkbox);
                });
                helpers.andThen(() => {
...
define('ember-flexberry/test-support/check-lock-edit-form', ['moment', 'ember-flexberry-data/utils/generate-unique-id', 'ember-flexberry/test-support/utils/create-recort-for-test'], function (_moment, _generateUniqueId, _createRecortForTest) {
  'use strict';

  Ember.Test.registerAsyncHelper('checkLockEditForm', function (app, olvSelector, context, assert, store, model, prop, path) {
    const helpers = app.testHelpers;
    const olv = helpers.findWithAssert(olvSelector, context);

    const currentData = (0, _moment.default)().format('DD.MM.YYYY HH:mm');
    const testRecord = (0, _generateUniqueId.default)();
    ...
    Ember.RSVP.all([(0, _createRecortForTest.createRecord)(store, model, prop, testRecord, currentData), lockRecord.save()]).then(() => {
...
define('ember-flexberry/test-support/check-lookup-dialogs', [], function () {
  'use strict';

  Ember.Test.registerAsyncHelper('checkLookupDialogs', function (app) {
    const helpers = app.testHelpers;
...
define('ember-flexberry/test-support/check-olv-config', [], function () {
  ...
  Ember.Test.registerAsyncHelper('checkOlvConfig', function (app, olvSelector, context, assert, config = []) {
    const helpers = app.testHelpers;
    const olv = helpers.findWithAssert(olvSelector, context);
...
define('ember-flexberry/test-support/check-olv-sort-for-each-column', ['ember-flexberry/test-support/utils/check-olv-sort-function'], function (_checkOlvSortFunction) {
  'use strict';

  Ember.Test.registerAsyncHelper('checkOlvSortForEachColumn', function (app, olvSelector, context, assert) {
    const helpers = app.testHelpers;
    const olv = helpers.findWithAssert(olvSelector, context);
  ...
  let checkColumns = function (headCells, index, olv, helpers, assert) {
    ...
    helpers.andThen(() => {
      const sortValue = (0, _checkOlvSortFunction.getHeaderSort)(olv, index, helpers);
...
define('ember-flexberry/test-support/check-olv-sort-on-all-columns', ['ember-flexberry/test-support/utils/check-olv-sort-function'], function (_checkOlvSortFunction) {
  'use strict';

  Ember.Test.registerAsyncHelper('checkOlvSortOnAllColumns', function (app, olvSelector, context, assert) {
    const helpers = app.testHelpers;
    const olv = helpers.findWithAssert(olvSelector, context);
    const headCells = helpers.find('thead .dt-head-left', olv).toArray();
...
define('ember-flexberry/test-support/utils/check-olv-sort-function', ['exports'], function (exports) {
  'use strict';
...
define('ember-i18n/test-support/index', ['exports', '@ember/test-helpers', 'ember-i18n/test-support/-private/t', 'ember-i18n/test-support/-private/assert-translation'], function (exports, _testHelpers, _t2, _assertTranslation2) {
  ...
  function expectTranslation(element, key, interpolations) {
    let { owner } = (0, _testHelpers.getContext)();
    let text = (0, _t2.default)(owner, key, interpolations);
